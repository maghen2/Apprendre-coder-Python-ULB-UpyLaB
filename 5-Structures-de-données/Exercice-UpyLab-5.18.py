# Exercice UpyLab 5.18 - Parcours : rouge
...
# Exemples
# Pour tester dans votre IDE (Thonny ou PyCharm par exemple) la fonction my_filter, vous allez devoir définir une fonction booléenne f et la passer en argument à la fonction my_filter.

# Vous pourrez donc d’abord définir la fonction f à l’aide du mot-clé def, mais sachez que l’on peut aussi définir directement la fonction f lors de l’appel à la fonction my_filter en utilisant ce qu’on appelle une fonction lambda.
...
# Cette fonction testera si l’objet x qu’on lui passe est de type int et fait le même travail que la fonction is_int plus classiquement définie ci-dessous :
